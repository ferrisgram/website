          ...
          <div className="lg:flex py-10">
            <div className="w-full lg:w-1/2">
              ...
              <h2 className="font-notoSans font-xl text-[#d9d9d9] text-2xl pl-7">
                An elegant{" "}
                <span className="font-semibold text-[#2EA2DD]">
                  Rust Client
                </span>{" "}
                for the{" "}
                <span className="font-semibold text-[#2EA2DD]">
              ...
              <div className="lg:pt-24 pt-10 pl-7">
                <span className="text-4xl font-bold font-notoSans text-white">
                  KEY FEATURES
                </span>
                <ul className="pl-10 pt-2 list-disc text-[#F8F8F8] text-lg space-y-3">
                  <li>
                    <span className="font-notoSans font-bold text-[#2AABEE]">
                      Easy to use:
                    </span>{" "}
                    <span className="text-gray-200">
                      ...
                      <a
                        ...
                        target={"_blank"}
                        rel="noreferrer"
                        className="text-gray-200 hover:text-blue-300 hover:underline transition-colors duration-300"
                      >
                        python-telegram-bot
                      </a>
                      , Ferrisgram is designed so that even a beginner can
                      easily make a bot with it.
                    </span>
                  </li>
                  ...
                  <li>
                    ...
                    <span className="text-gray-200">
                      ...
                      of the native Bot API types and methods make it typo-free.
                    </span>
                  </li>
